							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										...
										<li class="coupon_price" data-price="{{Session::get('coupon')['value']}}">You Save<span>PKR.{{number_format(Session::get('coupon')['value'],0)}}</span></li>
										@endif
										@php
										...
										@endphp
										@if(session()->has('coupon'))
											<li class="last" id="order_total_price">You Pay<span>PKR.{{number_format($total_amount,0)}}</span></li>
										@else
											<li class="last" id="order_total_price">You Pay<span>PKR.{{number_format($total_amount,0)}}</span></li>
										@endif
									</ul>
